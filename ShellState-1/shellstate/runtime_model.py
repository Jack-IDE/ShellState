...
from shellstate.engine import A, TerminalApp
...
DATA_FILE = os.path.join(RUNTIME_DIR, "demo_save.json")
SNAPSHOT_BASE = os.path.join(SNAPSHOTS_DIR, "demo_save")
